...
int main(int argc, char const *argv[])
{
    ...
    if (child_pid >= 0)
    {
        if (child_pid == 0)
        {
            ...
            {
                printf("child process close(fds[1]) failed\n");
            }
            ...
            while (1 )
            {
                ...
                {
                    printf("child process pipe end-of-pipe\n");
                    break;
                }
                else
                {
        ...
        { 
            ...
            {
                printf("parent process close(fds[0]) failed\n");
            }
            ...
            {
                printf("parent process close(fds[1]) failed\n");
            }
        }
    }
    else
